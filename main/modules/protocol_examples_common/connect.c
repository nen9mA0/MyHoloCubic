...
static esp_netif_t *wifi_start(char* ssid, char* passwd);
...
static void start(char* ssid, char* passwd)
{
    s_example_esp_netif = wifi_start(ssid, passwd);
    s_active_interfaces++;
...
esp_err_t example_connect(char* ssid, char* passwd)
{
#if EXAMPLE_DO_CONNECT
